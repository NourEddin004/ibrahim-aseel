...
The ornaments on the invitation are drawn, not downloaded, and three of
...
| `scene.py` | the evening plate: bulbs, tapers, the swag | the evening section |

All three seed a small LCG from the wedding date, so re-running any of
